...
async function createErrorsTable() {
  ...
  await pool.query(`
    ...
    CREATE INDEX IF NOT EXISTS idx_typescript_errors_scan_id ON typescript_errors(scan_id);
    CREATE INDEX IF NOT EXISTS idx_typescript_errors_file ON typescript_errors(file);
    CREATE INDEX IF NOT EXISTS idx_typescript_errors_pattern_id ON typescript_errors(pattern_id);
  `);
...
async function createAnalysisTable() {
  ...
  await pool.query(`
    ...
    CREATE INDEX IF NOT EXISTS idx_error_analysis_error_id ON error_analysis(error_id);
  `);
