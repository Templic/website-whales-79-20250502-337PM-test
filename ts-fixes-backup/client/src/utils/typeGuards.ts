 ...
 */
export function isProduct(value$2: value is Product {
  return (
    value !== null &&
    typeof value === 'object' &&
 ...
 */
export function isUser(value$2: value is User {
  return (
    value !== null &&
    typeof value === 'object' &&
    typeof value.id === 'string' &&
 ...
 */
export function isCartItem(value$2: value is CartItem {
  return (
    value !== null &&
    typeof value === 'object' &&
    typeof value.id === 'string' &&
 ...
 */
export function isOrder(value$2: value is Order {
  return (
    value !== null &&
    typeof value === 'object' &&
    typeof value.id === 'string' &&
 ...
 */
export function isAddress(value$2: value is Address {
  return (
    value !== null &&
    typeof value === 'object' &&
    typeof value.firstName === 'string' &&
 ...
 */
export function isBlogPost(value$2: value is BlogPost {
  return (
    value !== null &&
    typeof value === 'object' &&
    typeof value.id === 'string' &&
 ...
 */
export function isTrack(value$2: value is Track {
  return (
    value !== null &&
    typeof value === 'object' &&
    typeof value.id === 'string' &&
 ...
 */
export function isAlbum(value$2: value is Album {
  return (
    value !== null &&
    typeof value === 'object' &&
    typeof value.id === 'string' &&
 ...
 */
export function isTourDate(value$2: value is TourDate {
  return (
    value !== null &&
    typeof value === 'object' &&
    typeof value.id === 'string' &&
 ...
 */
export function isArrayOf<T>(value$2 itemGuard: (item$2 => item is T): value is T[] {
