...
export function UpcomingCeremoniesGrid({
  ceremonies = [
    ...
    },
    {
      ...
      location: "Ancient Grove, Portland",
      facilitator: "Eagle Feather",
      description: "Journey into non-ordinary reality with the rhythmic beat of the shamanic drum. This traditional practice allows you to connect with spirit guides, power animals, and ancestral wisdom to receive healing and guidance for your life path.",
      imageSrc: "/placeholder.svg?height=400&width=600",
      category: "Shamanic",
      price: "$65",
      capacity: 15,
    ...
    },
    {
      ...
      location: "Moon Temple, Boulder",
      facilitator: "Celeste Moondancer",
      description: "Harness the powerful energy of the new moon to plant seeds of intention for your personal growth and manifestation. This ceremony includes guided meditation, journaling, and a sacred fire ritual to release the old and welcome in the new.",
      imageSrc: "/placeholder.svg?height=400&width=600",
      category: "Moon Ceremony",
      price: "$40",
      capacity: 25,
      spotsLeft: 15,
      duration: "2 hours",
      level: "All Levels",
      tags: ["New Moon", "Intention Setting", "Manifestation", "Ritual"]
    },
    {
      id: "ceremony-6",
      title: "Ecstatic Dance & Medicine Music",
      date: "May 25, 2025",
      time: "7:00 PM - 10:00 PM",
      location: "Rhythm Sanctuary, Austin",
      facilitator: "DJ Shakti Flow",
      description: "Free your body and spirit through the practice of ecstatic dance, guided by live medicine music. This ceremony allows you to release inhibitions, express emotions, and connect with your authentic self through movement and rhythm.",
      imageSrc: "/placeholder.svg?height=400&width=600",
      category: "Movement",
      price: "$35",
      capacity: 50,
      ...
      duration: "3 hours",
      level: "All Levels",
      tags: ["Ecstatic Dance", "Medicine Music", "Movement", "Expression"]
    },
  ],
  title = "Upcoming Ceremonies",
  subtitle = "Join our transformative ceremonies led by experienced facilitators in sacred spaces around the world."
  ...
  const categories = [...new Set(ceremonies.map(ceremony => ceremony.category))];
  
  // Filter ceremonies by category if filter is set
                ...
                <TabsContent value="facilitator" className="pt-4">
                  <div className="flex flex-col md:flex-row gap-6">
                    ...
                    <div className="md:w-2/3 space-y-4">
                      <div>
                        <h4 className="text-white font-medium mb-2">About {selectedCeremony.facilitator}</h4>
                        <p className="text-white/70 text-sm">
                          {selectedCeremony.facilitator} is a master practitioner with over 10 years of experience leading transformative ceremonies around the world. Their unique approach combines ancient wisdom traditions with modern healing modalities to create powerful experiences of growth and awakening.
                        </p>
                      </div>
