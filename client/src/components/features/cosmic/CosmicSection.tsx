...
/**
 * Original CosmicSection component merged from: client/src/components/common/cosmic-section.tsx
 * Merge date: 2025-04-05
 */
function CosmicSectionOriginal({
  children,
  className,
  variant = "default",
  containerClassName,
...
/**
 * Original CosmicSection component merged from: client/src/components/ui/cosmic-section.tsx
 * Merge date: 2025-04-05
 */
function CosmicSectionUIOriginal({
  children,
  className,
  variant = "default",
  containerClassName,
