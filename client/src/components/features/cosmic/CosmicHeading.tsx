...
export function CosmicHeading({
  ...
  glow = true,
  animated = true,
  font = "default", // Changed default to "default" since we might not have the custom fonts
  color = "text-white",
  withAccent = false,
}: CosmicHeadingProps) {
  ...
  // Define font classes
  const fontClass = {
    orbitron: "font-sans", // Fallback to system font
    nebula: "font-sans", // Fallback to system font
    space: "font-sans", // Fallback to system font
    default: "font-sans",
  }[font]
...
/**
 * Original CosmicHeading component merged from: client/src/components/common/cosmic-heading.tsx
 * Merge date: 2025-04-05
 */
function CosmicHeadingOriginal({
  children,
  level = 2,
  className,
  align = "left",
