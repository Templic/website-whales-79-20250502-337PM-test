...
function AccessibilityControlsPascalCaseOriginal() {
  ...
  return (
    <>
      ...
      <button
        onClick={() => setIsOpen(true)}
        className="fixed bottom-4 right-4 z-50 flex h-12 w-12 items-center justify-center rounded-full bg-purple-600 text-white shadow-lg hover:bg-purple-7000 focus:outline-none focus:ring-2 focus:ring-purple-400 focus:ring-offset-2"
        aria-label="Accessibility Options"
      >
        <Settings className="h-6 w-6" />
      </button>
