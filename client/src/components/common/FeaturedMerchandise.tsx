      ...
      <div className="grid md:grid-cols-3 gap-6">
        <div className="bg-[rgba(48,52,54,0.5)] p-6 rounded-lg">
          ...
          <a
            ...
            className="bg-[#00ebd6] text-[#303436] px-4 py-2 rounded-lg hover:bg-[#fe0064] hover:text-white transition-colors w-full inline-block text-center"
          >
            Buy Now
          </a>
        </div>
        <div className="bg-[rgba(48,52,54,0.5)] p-6 rounded-lg">
          <img src="https://i.etsystatic.com/54804470/r/il/15c48e/6530624025/il_1588xN.6530624025_7yel.jpg" alt="Digital Art" className="w-full rounded-lg mb-4" />
          <h3 className="text-xl font-bold mb-2">Orca Sunrise Cove by Dale The Whale on Etsy.com</h3>
          <p className="mb-4">$45.00</p>
          <a
