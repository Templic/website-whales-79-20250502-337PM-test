...
const pageMigrations = [
  // Examples (these would need to be filled with actual page paths)
  // Active pages
  ...
  // Admin pages
  ['client/src/pages/AdminPortalPage.tsx', 'client/src/pages/admin/PortalPage.tsx', 'active'],
  ['client/src/pages/AnalyticsPage.tsx', 'client/src/pages/admin/AnalyticsPage.tsx', 'active'],
  ['client/src/pages/UsersPage.tsx', 'client/src/pages/admin/UsersPage.tsx', 'active'],
  
  // Archived pages
  ['client/src/pages/OldMusicPage.tsx', 'client/src/pages/archived/music/OldMusicPage.tsx', 'archived'],
  ['client/src/pages/DeprecatedShopPage.tsx', 'client/src/pages/archived/shop/DeprecatedShopPage.tsx', 'archived'],
];
