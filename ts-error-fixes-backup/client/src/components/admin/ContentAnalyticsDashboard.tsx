...
export function ContentAnalyticsDashboard() {
  ...
  const getPublishingPerformance = () => {
    ...
    return analyticsData.dailyMetrics.map((metric$2 => ({
                ...
                <div className="h-[300px]">
                  <ResponsiveContainer width="100%" height="100%">
                    <PieChart>
                      ...
                      <Legend />
                      <Tooltip 
                        formatter={(value$2 => [`${value} items`, 'Count']}
                      />
                    </PieChart>
                  </ResponsiveContainer>
                </div>
                ...
                <div className="h-[300px]">
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                      ...
                      <Tooltip 
                        formatter={(value$2 => [`${value} hours`, 'Time']}
                      />
              ...
              <CardContent>
                <div className="space-y-4">
                  {analyticsData.attentionItems?.length > 0 ? (
                    analyticsData.attentionItems.map((item$2 index: number) => (
