...
/**
 * Original LiveSession component merged from: client/src/components/common/live-session.tsx
 * Merge date: 2025-04-05
 */
function LiveSessionOriginal({
  releaseId,
  title = "Cosmic Healing Frequencies - Live Release Session",
  scheduledTime = "2024-04-15T19:00:00Z",
  isLive = false,
...
/**
 * Original LiveSession component merged from: client/src/components/common/LiveSession.tsx
 * Merge date: 2025-04-05
 */
function LiveSessionOriginal({
  releaseId,
