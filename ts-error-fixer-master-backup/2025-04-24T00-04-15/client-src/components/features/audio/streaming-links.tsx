...
/**
 * Original StreamingLinks component merged from: client/src/components/common/streaming-links.tsx
 * Merge date: 2025-04-05
 */
function StreamingLinksOriginal() {
  const platforms = [
    {
      name: "Spotify",
      icon: "/placeholder.svg?height=40&width=40",
...
/**
 * Original StreamingLinks component merged from: client/src/components/common/StreamingLinks.tsx
 * Merge date: 2025-04-05
 */
function StreamingLinksOriginal() {
  const platforms = [
...
/**
 * Original StreamingLinks component merged from: client/src/components/features/audio/StreamingLinks.tsx
 * Merge date: 2025-04-05
 */
function StreamingLinksOriginal() {
  const platforms = [
