...
/**
 * Original Newsletter component merged from: client/src/components/common/newsletter.tsx
 * Merge date: 2025-04-05
 */
function NewsletterOriginal() {
  const [email, setEmail] = useState("")
  const [status, setStatus] = useState<"idle" | "loading" | "success" | "error">("idle")
  const [message, setMessage] = useState("")
...
/**
 * Original Newsletter component merged from: client/src/components/features/community/Newsletter.tsx
 * Merge date: 2025-04-05
 */
function NewsletterOriginal() {
  const [email, setEmail] = useState("")
