...
export function createInputValidationMiddleware(options: InputValidationOptions = {}) {
   ...
   */
  function validateObject(path: string, obj: any, depth: number, result: ValidationResult): void {
   ...
   */
  function validateValue(path: string, value: any, result: ValidationResult): void {
    // Check string length
