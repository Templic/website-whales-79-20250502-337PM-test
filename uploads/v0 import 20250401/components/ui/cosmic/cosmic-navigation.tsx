...
import { Menu, X, Home, Archive, Sparkles, Compass, Headphones, Music } from "lucide-react"
...
export function CosmicNavigation() {
  ...
  // Define routes outside of component render to prevent recreation on each render
  const routes: NavItem[] = [
    ...
    },
    {
      ...
      description: "Sacred geometry frequency compositions",
    },
  ]
  ...
  }, [isHoveringMenu, pathname, routes])
  ...
  return (
    ...
    >
      <div className="container flex h-16 items-center justify-between">
        {/* Logo */}
        <Link href="/" className="flex items-center space-x-2 group z-10" aria-label="ASTRA - Return to home page">
        ...
        >
          <nav className="relative" aria-label="Main Navigation">
            ...
            <div
              className="absolute inset-0 -inset-x-6 -inset-y-3 bg-black/20 backdrop-blur-sm rounded-full border border-white/5"
              aria-hidden="true"
            ></div>
