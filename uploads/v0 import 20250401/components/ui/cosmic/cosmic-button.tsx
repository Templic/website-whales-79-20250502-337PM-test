...
export function CosmicButton({
  ...
  const getVariantClasses = () => {
    switch (variant) {
      ...
      case "primary":
      default:
        return "bg-gradient-to-r from-cosmic-sea-500 to-cosmic-sunset-600 hover:from-cosmic-sea-600 hover:to-cosmic-sunset-700 text-white"
    }
  }
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.98 }}
      className={cn(
        "relative font-medium transition-colors flex items-center justify-center gap-2",
        getSizeClasses(),
        getVariantClasses(),
