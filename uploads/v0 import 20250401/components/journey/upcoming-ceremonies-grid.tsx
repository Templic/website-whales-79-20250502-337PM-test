...
export function UpcomingCeremoniesGrid({
  ceremonies = [
    {
      ...
      description:
        "Immerse yourself in the healing vibrations of crystal singing bowls, gongs, and chimes during this powerful full moon ceremony. The full moon amplifies the effects of sound healing, helping to release what no longer serves you and manifest your intentions with greater clarity.",
    ...
    },
    {
      ...
      description:
        "Begin with a sacred cacao ceremony to open your heart, followed by a guided breathwork journey to access expanded states of consciousness. This powerful combination creates a deep healing experience that connects you with your inner wisdom and the universal life force.",
      imageSrc: "/placeholder.svg?height=400&width=600",
      category: "Breathwork",
      price: "$55",
      capacity: 25,
    ...
    },
    {
      ...
      description:
        "Experience the cutting-edge of sound healing with this quantum approach that combines binaural beats, solfeggio frequencies, and vocal toning. This ceremony works with the quantum field to reorganize your energy and create coherence between your heart and brain.",
      imageSrc: "/placeholder.svg?height=400&width=600",
      category: "Sound Healing",
      price: "$60",
      capacity: 20,
    ...
    },
    {
      ...
      description:
        "The rhythmic beating of the drum will guide you into a trance state where you can connect with spirit guides, power animals, and receive insights from non-ordinary reality. This ancient shamanic practice helps you access deep wisdom and healing.",
      imageSrc: "/placeholder.svg?height=400&width=600",
      category: "Shamanic",
      price: "$50",
      capacity: 15,
  ...
  const filteredCeremonies = filter ? ceremonies.filter((ceremony) => ceremony.category === filter) : ceremonies

  // Open ceremony details dialog
  const openCeremonyDetails = useCallback((ceremony: Ceremony) => {
    setSelectedCeremony(ceremony)
    setActiveTab("details")
  }, [])

  // Close ceremony details dialog
  const closeCeremonyDetails = useCallback(() => {
              ...
              <CosmicCard className="p-0 overflow-hidden h-full flex flex-col">
                <div className="relative h-48">
                  ...
                  <div className="absolute bottom-0 left-0 p-4">
                    <Badge
                      variant="secondary"
                      className="bg-purple-500/80 hover:bg-purple-500/90 text-white border-none"
                    >
                      {ceremony.category}
                    </Badge>
                  </div>
                ...
                <div className="p-4 flex-1 flex flex-col">
                  ...
                  <p className="text-white/60 text-sm line-clamp-3 mb-4">{ceremony.description}</p>
      ...
      <Dialog open={!!selectedCeremony} onOpenChange={() => closeCeremonyDetails()}>
        <DialogContent className="bg-black/90 border border-purple-500/30 backdrop-blur-lg max-w-3xl">
          {selectedCeremony && (
            <>
              <DialogHeader>
                <DialogTitle className="text-xl text-white">{selectedCeremony.title}</DialogTitle>
              ...
              <Tabs value={activeTab} onValueChange={setActiveTab} className="mt-2">
                <TabsList className="bg-black/50 border border-white/10">
                  ...
                  <TabsTrigger value="location" className="data-[state=active]:bg-purple-900/50">
                    Location
                  </TabsTrigger>
                  <TabsTrigger value="facilitator" className="data-[state=active]:bg-purple-900/50">
                    Facilitator
                  </TabsTrigger>
                </TabsList>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-white/70 text-sm">
                        Detailed directions will be sent to you after registration. The venue is easily accessible by
                        public transportation and has parking available nearby.
                      </p>
                    </div>
                  </div>
                </TabsContent>
                ...
                <TabsContent value="facilitator" className="pt-4">
                  <div className="flex flex-col md:flex-row gap-6">
                    ...
                    <div className="md:w-2/3 space-y-4">
                      ...
                      <p className="text-white/70 text-sm">
                        With over 10 years of experience in sound healing and energy work,{" "}
                        {selectedCeremony.facilitator} brings a unique blend of ancient wisdom and modern techniques to
                        create transformative ceremonial experiences. Their approach is heart-centered, intuitive, and
                        deeply respectful of the sacred traditions they draw from.
                      </p>

                      <div>
                        <h4 className="text-white font-medium mb-2">Specialties</h4>
                        <div className="flex flex-wrap gap-2">
                          <Badge variant="outline" className="bg-black/50 text-white/80">
                            Sound Healing
                          </Badge>
                          <Badge variant="outline" className="bg-black/50 text-white/80">
                            Energy Work
